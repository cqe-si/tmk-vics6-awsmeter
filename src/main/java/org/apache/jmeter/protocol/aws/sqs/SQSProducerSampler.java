 ...
 */
public abstract class SQSProducerSampler extends SQSSampler {
    ...
    /**
     * Message Group Id (FIFO Topic). All messages belong to same group id are
     * delivered FIFO order (First-In-First-Out).
     */
     ...
     * @return SendMessageRequest with message elements like body, attributes,
     *         deduplication id, group id and more.
     * @throws JsonProcessingException
     *                                 Exception when deserialize JSON to Object.
     */
    public abstract SendMessageRequest createSendMessageRequest(final JavaSamplerContext context)
            throws JsonProcessingException;
     ...
     *                                 Exception when deserialize JSON to Object.
     */
    public Map<String, MessageAttributeValue> buildMessageAttributes(final String msgAttributes)
            throws JsonProcessingException {
    ...
    /**
     * Predicate to validate the message attribute object is String or Custom String
     * type.
     */
    Predicate<MessageAttribute> isStringDataType = msg -> msg.getType().startsWith(MSG_ATTRIBUTE_TYPE_STR);

    /**
     * Function to create AWS Message Attribute Value object of String or Custom
     * String type.
     */
    ...
    /**
     * Predicate to validate the message attribute object is Number or Custom Number
     * type.
     */
    Predicate<MessageAttribute> isNumberDataType = msg -> msg.getType().startsWith(MSG_ATTRIBUTE_TYPE_NUM);

    /**
     * Function to create AWS Message Attribute Value object of Number or Custom
     * Number type.
     */
    ...
    /**
     * Predicate to validate the message attribute object is Binary or Custom Binary
     * type.
     */
    Predicate<MessageAttribute> isBinaryDataType = msg -> msg.getType().startsWith(MSG_ATTRIBUTE_TYPE_BIN);

    /**
     * Function to create AWS Message Attribute Value object of Binary or Custom
     * Binary type.
     */
